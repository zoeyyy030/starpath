import {DataLoader} from './DataLoader.js?v=0403';
...
export class LessonPlayer {
  ...
  async showCatalog(){
    ...
    this.ui.catalogStatus.textContent='';if(this.devMode){$('devPanel').classList.remove('hidden');$('devStatus').textContent=`当前解锁 Day ${this.progress.data.currentDay}`;$('unlockAll').onclick=()=>{this.progress.unlockAll();location.reload()};$('resetProgress').onclick=()=>{this.progress.reset();location.reload()}}
  }
